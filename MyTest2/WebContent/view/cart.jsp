                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    <thead>
                                        <tr>
                                            <th>번호</th>
                                            <th align="center" colspan="2">제품명</th>
                                            <th>배송 주기</th>
                                            <th>최초 수령일</th>
                                            <th colspan="2">가격</th>
                                        </tr>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <!-- 사진 --><td>
                                                <a href="#">
                                                    <img src=${pageContext.request.contextPath}${article.detailCommand.prd_img} alt="${article.detailCommand.prd_name}">
                                                </a>
                                            </td>
                                            <!-- 제품명 --><td><a href="#">${article.detailCommand.prd_name}</a></td>
                                            <!-- 배송주기 --><td>${article.cart_cycle}주에 한 번</td>
                                            <!-- 최초 수령일 --><td>${fn:substring(article.cart_takedate,0,10)}</td>
                                            <!-- 결제 가격 --><td>${article.detailCommand.prd_price}</td>
